...
function journalistic_customizer_stylesheet() {
	wp_enqueue_style( 'journalistic-customizer-css', get_template_directory_uri().'/css/customize-css.css', NULL, NULL, 'all' );
}
	...
	$wp_customize->add_setting('journalistic_rating[info]', array(
		'sanitize_callback' => 'journalistic_no_sanitize',
		'type' => 'info_control',
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'rating_section', array(
		...
		'settings' => 'journalistic_rating[info]',
		'type' => 'textarea',
		'priority' => 105
		) )
	);   
	...
	$wp_customize->add_section(
		'journalistic_new',
		array(
			'title' => __('Journalistic Pro', 'journalistic'),
			'priority' => 999,
			'description' => __('<a href="https://lighthouseseooptimization.github.io/wordpress/journalistic/" target="_blank"><img src="https://raw.githubusercontent.com/lighthouseseooptimization/wordpress/master/journalistic/img/themeinfo-customizer.png"></a><p><strong>Got questions or need help?</strong></p><a href="https://lighthouseseooptimization.github.io/wordpress/journalistic/#contact" target="_blank">Email us here</a> or write to us directly at: Beseenseo@gmail.com <br><br> Upgrade to Journalistic Pro to get 30+ more features! ', 'journalistic') . '<a href="https://lighthouseseooptimization.github.io/wordpress/journalistic/" target="_blank">Upgrade now!</a> <br> 
			...
			<ul>
				...
				<li>Change Global Color</li>
				<li>Show Header On All Pages</li>
				<li>Custom Footer Copyright Text</li>
				<li>Custom Navigation Colors</li>
				<li>Custom Navigation Logo</li>
				<li>Custom Post Colors</li>
				<li>Custom Page Colors</li>
				<li>Custom Blog Feed Colors</li>
				<li>Custom Sidebar Colors</li>
				<li>Custom Footer Colors</li>
				<li>Custom Background Image</li>
				<li>Custom Background Color</li>
				<li>Custom Header Title</li>
				<li>8 Different Social Media Header Icons</li>
				<li>Change Social Media Header Icons Color</li>
				<li>Custom Header Tagline</li>
				<li>Custom Header Colors</li>
				<li>Unlimited Customer Support</li>
				<li>Free Updates Forever</li>
			</ul>
			<a class="button button-primary" href="https://lighthouseseooptimization.github.io/wordpress/journalistic/" target="_blank">Upgrade now for $32</a>
			',
			)
		);  
	$wp_customize->add_setting('journalistic_options[info]', array(
		'sanitize_callback' => 'journalistic_no_sanitize',
		'type' => 'info_control',
		'capability' => 'edit_theme_options',
		)
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'pro_section', array(
		'section' => 'journalistic_new',
		'settings' => 'journalistic_options[info]',
		'type' => 'textarea',
		'priority' => 109
		) )
	);   
	...
	$wp_customize->add_section(
		'journalistic_contact',
		array(
			'title' => __('Help and Support', 'journalistic'),
			'priority' => 995,
			'description' => __('Have questions or need help? ', 'journalistic') . '<a href="https://lighthouseseooptimization.github.io/wordpress/journalistic/#contact" target="_blank">Email us here</a> or write to us directly at: Beseenseo@gmail.com<br><br><br><a href="https://lighthouseseooptimization.github.io/wordpress/journalistic/" target="_blank"><img src="https://raw.githubusercontent.com/lighthouseseooptimization/wordpress/master/journalistic/img/themeinfo-customizer.png"></a>',
			)
		);  
	$wp_customize->add_setting('journalistic_contact[info]', array(
		'sanitize_callback' => 'journalistic_no_sanitize',
		'type' => 'info_control',
		'capability' => 'edit_theme_options',
		)
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'contact_section', array(
		'section' => 'journalistic_contact',
		'settings' => 'journalistic_contact[info]',
		'type' => 'textarea',
		'priority' => 105
		) )
	);   
...
if(! function_exists('journalistic_header_bg_color_css' ) ):
/**
* Set the header background color 
*/
function journalistic_header_bg_color_css(){
	...
	<?php }
	add_action( 'wp_head', 'journalistic_header_bg_color_css' );
	endif;
