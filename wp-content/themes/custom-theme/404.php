		...
		<main id="main" class="site-main" role="main">
			...
			<section class="error-404 not-found">
				...
				<div class="page-content">
					...
					if ( mooks_market_categorized_blog() ) : ?>
					...
					$mooks_market_archive_content = '<p>' . sprintf( esc_html__( 'Try looking in the monthly archives. %1$s', 'shop-and-commerce' ), convert_smilies( ':)' ) ) . '</p>';
					the_widget( 'WP_Widget_Archives', 'dropdown=1', "after_title=</h2>$mooks_market_archive_content" );
